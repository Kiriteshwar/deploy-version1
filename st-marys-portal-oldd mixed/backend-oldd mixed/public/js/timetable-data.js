...
window.timetableData = {
  ...
  classes: [
    ...
    { class: 'X', section: 'A', day: 'Friday', period: 6, subject: 'Lunch Break', isBreak: true },
    { class: 'X', section: 'A', day: 'Friday', period: 7, subject: 'Mathematics', teacher: 'Teacher User' },
    { class: 'X', section: 'A', day: 'Friday', period: 8, subject: 'Computer Science', teacher: 'Teacher User-3' },
    { class: 'X', section: 'A', day: 'Friday', period: 9, subject: 'Break', isBreak: true },
    { class: 'X', section: 'A', day: 'Friday', period: 10, subject: 'History', teacher: 'Teacher User' },
    { class: 'X', section: 'A', day: 'Friday', period: 11, subject: 'Geography', teacher: 'Teacher User-2' },
    { class: 'X', section: 'A', day: 'Friday', period: 12, subject: 'Diary Period', isBreak: true },
